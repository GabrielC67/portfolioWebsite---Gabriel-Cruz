  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "neon-lg": "0 0 10px hsl(var(--primary)), 0 0 30px hsl(var(--primary) / 0.4), 0 0 50px hsl(var(--primary) / 0.2)",
        "neon-purple": "0 0 5px hsl(var(--secondary)), 0 0 20px hsl(var(--secondary) / 0.3)",
      },
    },
  },
